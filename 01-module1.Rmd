...
```{r aggregation structure, eval=FALSE, echo=FALSE}
library(DiagrammeR)
mermaid("
  graph TD
...
```{r 2-step calculation, eval=FALSE, echo=FALSE}
mermaid("
  graph TD
...
```{r example rebased index, echo=FALSE}
...
```{r example chained index, echo=FALSE}
