...
```{r structure, eval=FALSE, echo=FALSE}
library(DiagrammeR)
mermaid('
    graph TD
...
These instructions outline a simple way to build the price index for widgets, although feel free to use a different approach if it's easier. The goal is to understand the process, rather than design the most computationally efficient system. (Hint: look into the dplyr package and the [ppd](https://github.com/marberts/ppd) package for some useful tools.)
