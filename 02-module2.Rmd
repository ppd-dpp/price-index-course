...
ggplot() +
  ...
  theme_classic() +
  labs(x = "Price relative/Index value", title = "Example of the predicition error associated with different index values") +
