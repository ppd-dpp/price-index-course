...
\hypersetup{
  ...
  pdfauthor={Steve Martin and Rebecca Meier},
  hidelinks,
...
\NormalTok{index\_ab }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\FunctionTok{split}\NormalTok{(dat, dat}\SpecialCharTok{$}\NormalTok{group), }
                   \ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{mean\_geometric}\NormalTok{(x}\SpecialCharTok{$}\NormalTok{relative, x}\SpecialCharTok{$}\NormalTok{weight) }\SpecialCharTok{*} \DecValTok{100}\NormalTok{)}
\NormalTok{index\_ab}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{index\_top }\OtherTok{\textless{}{-}} \FunctionTok{mean\_geometric}\NormalTok{(index\_ab, }\FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{tapply}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{weight, dat}\SpecialCharTok{$}\NormalTok{group, sum)))}
...
\FunctionTok{mean\_geometric}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{relative, dat}\SpecialCharTok{$}\NormalTok{weight) }\SpecialCharTok{*} \DecValTok{100}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{mean\_geometric}\NormalTok{(index) }\SpecialCharTok{*} \DecValTok{100}
\end{Highlighting}
\end{Shaded}
