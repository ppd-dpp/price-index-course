...
\KeywordTok{c}\NormalTok{(}\DataTypeTok{Laspeyres =} \KeywordTok{mean_arithmetic}\NormalTok{(relatives, share0),}
  ...
  \DataTypeTok{Fisher =} \KeywordTok{sqrt}\NormalTok{(}\KeywordTok{mean_arithmetic}\NormalTok{(relatives, share0) }\OperatorTok{*}
...
\StringTok{  }\CommentTok{# your code here (hint: read the documentation for dplyr::lag)}
\end{Highlighting}
\end{Shaded}
\item
...
\NormalTok{dat_index <-}\StringTok{ }\NormalTok{dat_index }\OperatorTok{%>%}\StringTok{  }
\StringTok{  }\CommentTok{# your code here %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{share_prod_u =} \KeywordTok{weights_update}\NormalTok{(}\KeywordTok{cumprod}\NormalTok{(}\KeywordTok{lag}\NormalTok{(rel, }\DataTypeTok{default =} \DecValTok{1}\NormalTok{)), share_prod)) }\CommentTok{# price update the weights}
\end{Highlighting}
\end{Shaded}
\item
