...
\NormalTok{micro\_prices }\OtherTok{\textless{}{-}} \FunctionTok{transform}\NormalTok{(micro\_prices, }
                          \AttributeTok{period =} \FunctionTok{format}\NormalTok{(}\FunctionTok{as.Date}\NormalTok{(period), }\StringTok{"\%Y\%m"}\NormalTok{), }
...
\NormalTok{pias }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{(}\FunctionTok{split}\NormalTok{(weights, weights}\SpecialCharTok{$}\NormalTok{basket), }
               \ControlFlowTok{function}\NormalTok{(df) \{}
